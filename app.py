...
model = YOLO("/home/ubuntu/YOLO_weed/model_deployed/best.pt")
...
if uploaded_file:
    ...
    if file_extension in ["jpg", "jpeg", "png"]:
        ...
        results = model.predict(source=np.array(image), conf=0.5, device="cuda")
        ...
        while cap.isOpened():
            ...
            # Run YOLO detection
            results = model.predict(source=frame_rgb, conf=0.5, device="cuda")
