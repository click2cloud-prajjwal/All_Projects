...
WEIGHT_PATH = "model/sugarcane_pest_classifier.pth"  # Update with your actual path
...
# Streamlit UI
st.title("Sugarcane Pest Detection")
...
if uploaded_file is not None:
    ...
    # Class names mapping
    class_names = ["borer", "leafmite", "pyrilla", "whiteflies", "whitegrub", "woolyaphids"]
