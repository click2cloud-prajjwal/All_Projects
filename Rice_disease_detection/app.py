...
rf_model = joblib.load("/home/ubuntu/yolo_disease/AI-Rice_Disease-and-Weed_detection/meta_model.pkl")

# Load Class Mapping
class_map = joblib.load("/home/ubuntu/yolo_disease/AI-Rice_Disease-and-Weed_detection/class_map.pkl")  # Ensure this file contains a dictionary mapping indices to class names
